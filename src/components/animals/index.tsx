...
export default function Animals() {
  ...
  // Acessando os dados de paginação - ajuste aqui para a estrutura correta
    ...
    <>
      <div className="flex flex-col mx-auto px-20 py-6 xl:py-8 max-h-auto">
        <div className="flex flex-row justify-center gap-10">
          {/* Área de filtros */}
          <div className="flex flex-col gap-4 bg-asecondary/40 h-fit w-1/4 rounded-xl px-4 py-4">
