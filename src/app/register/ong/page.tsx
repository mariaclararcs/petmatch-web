            ...
            <main className="flex flex-col justify-between items-center mx-auto px-12 py-6 xl:py-8 h-full">
                <div className="flex flex-col items-center">
                    ...
                    <form action="" className="flex flex-col py-4">
                        ...
                        <input type="text" className="rounded-xl border-2 border-border px-4 py-3 mb-6" required/>
                        <label className="mb-1">Nome do Responsável *</label>
                        <input type="text" className="rounded-xl border-2 border-border px-4 py-3 mb-6" required/>
                        <label className="mb-1">E-mail *</label>
                        <input type="email" className="rounded-xl border-2 border-border px-4 py-3 mb-6" required/>
                        ...
                        <div className="flex flex-row gap-8 w-full">
                            <div className="flex flex-col w-full">
                                ...
                                <input type="password" className="rounded-xl border-2 border-border px-4 py-3 mb-6" required/>
                            </div>
                            <div className="flex flex-col w-full">
                        ...
                        <textarea className="w-full rounded-xl border-2 border-border px-4 py-3 mb-6"/>
